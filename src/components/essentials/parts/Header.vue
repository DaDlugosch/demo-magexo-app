    ...
    <RouterLink to="/">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 357.26 64">
        ...
        <g id="V">
          <path
              class="fill-logo-dark dark:fill-white"
              d="M51.81 6.63a3.88 3.88 0 013.6-2.52 3.5 3.5 0 013.69 3.51 5.34 5.34 0 01-.36 1.53L36.87 63.42a5.3 5.3 0 01-5.13 3.69c-2.7 0 .09-9.54.09-9.54z"
              transform="translate(-4.24 -3.61)"
          />
          <path
              d="M35 66.06a5.37 5.37 0 01-8.29-2.64L5.1 9.24a5.34 5.34 0 01-.36-1.53 3.52 3.52 0 013.69-3.6 3.67 3.67 0 013.51 2.52l19.89 50.94z"
              transform="translate(-4.24 -3.61)"
              fill="#5c87ff"
              stroke="#5c87ff"
